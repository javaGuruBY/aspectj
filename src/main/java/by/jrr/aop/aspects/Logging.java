...
//    @Before("execution(* by.jrr.aop.service.UserServiceI.createUser())")
    public void logBefore(JoinPoint joinPoint) {
        log.info("*** hijacked in logBefore(): [{}] *** ", joinPoint.getSignature().getName());
    }

//    @After("execution(* by.jrr.aop.service.UserServiceI.updateUser())")
    public void logAfter(JoinPoint joinPoint) {
        log.info("*** hijacked in logAfter(): [{}] *** ", joinPoint.getSignature().getName());
    }

//    @AfterReturning(
//            pointcut = "execution(* by.jrr.aop.service.UserServiceI.createUser())",
...
//    @Around("execution(* by.jrr.aop.service.UserServiceI.simpleOperationOnUser(..))")
...
//    @AfterThrowing(
//            pointcut = "execution(* by.jrr.aop.service.UserServiceI.riskyOperationOnUser())",
//            throwing = "capturedEx")
